...
namespace ShiNengShiHui.Migrations.SeedData.EntitiesData
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(ShiNengShiHuiDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new ShiNengShiHuiAuthorizationProvider())
            ...
            if (adminUser == null)
            {
                adminUser = User.CreateTenantAdminUser(_tenantId, "lyf670354671@gmail.com", "123qwe");
